...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('assets/adm/plugins/fontawesome-free/css/all.min.css')}}">
    <!-- icheck bootstrap -->
...
<body class="hold-transition login-page">
    ...
    <!-- jQuery -->
    <script src="{{asset('assets/adm/plugins/jquery/jquery.min.js')}}"></script>
    <!-- Bootstrap 4 -->
    <script src="{{asset('assets/adm/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <!-- AdminLTE App -->
